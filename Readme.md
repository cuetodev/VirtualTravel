...
`¿Cómo funciona?:` A la hora de hacer una reserva primero compruebo si existe un autobús con las características que quiero para la reserva, de lo contrario, creo el autobús totalmente transparente al usuario y asigno la reserva al autobús. Si el autobús existe entonces simplemente asigno la reserva al autobús.
